...
class mainDestinationPage extends StatelessWidget {
  ...
  List finaldestination = ["Annapurna Base camp",
                          "Mardi Base Camp",
                          "Tilicho Lake",
                          "Everest Base Camp"];
  ...
  Widget _getInnerButtom(int index, double latitude, double longitude, String finaldestination) {
        ...
        child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              return SimpleFoldingCell(
                  ...
                  innerBottomWidget:
                      _getInnerButtom(index, latitude[index], longitude[index],finaldestination[index]),
